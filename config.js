...
window.OPENFLOW = {
  ...
  models: [
    ...
    { id: "poolside/laguna-xs-2.1", provider: "NVIDIA", limit: "30/m", blurb: "Poolside Laguna XS." },
    ...
    { id: "mistral-large-latest", provider: "Mistral", limit: "1/s", blurb: "Mistral's flagship. One call a second, shared by everyone." },
